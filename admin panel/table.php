...
<body>
    <div class="container">
        <h2 class="mb-4" id="topic1">User Information</h2>
        <a class='btn btn-primary me-2' id="btn1" href="insert.php">Add new user</a> 
        <br></br>
        <div class="tb1">
            <table class="table table-striped" style="margin: auto; width: 100%;  overflow-x: auto;table-layout: fixed; opacity:0.9;" id="table1">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<a class='btn btn-primary me-2' href='../profile/index.php?id={$row['userID']}'>View</a><br><br>";
                        echo "<a class='btn btn-success me-2' href='edit.php?id={$row['userID']}'>Edit</a> <br><br>";
