...
<body>
    <div class="container">
        <h2>Edit User</h2>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $userID; ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label for="nameInput">Name</label>
                <input type="text" class="form-control" id="nameInput" name="nameInput" value="<?php echo $name; ?>" oninput="validateName()" >
                <span id="error"></span>
            </div>
            
            <div class="form-group">
                <label for="positionInput">Position</label>
                <input type="text" class="form-control" id="positionInput" value="<?php echo $position; ?>" name="positionInput" placeholder="Enter Position" oninput="validatePosition()" >
                <span id="errorPosition"></span>
            </div><br>
        
            <div class="form-group">
                <label for="descriptionInput">Description</label>
                <textarea class="form-control" id="descriptionInput" name="descriptionInput" placeholder="Tell Something about you" required><?php echo $description; ?></textarea>
            </div><br>

            <div class="form-group">
                <label for="descriptionInput">Home Address</label>
                <input type="text" class="form-control" id="addressInput" value="<?php echo $address; ?>" name="addressInput" placeholder="Enter the address" >
                <span id="descerror"></span>
            </div><br>
        
            <div class="form-group">
                <label for="profilePictureInput">Choose a Profile Picture</label><br>
                <input type="file" class="form-control-file" id="profilePictureInput" value="<?php echo $profilePicture; ?>" name="profilePictureInput" accept="image/*"  onchange="validateImage()" required>
                <br>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="contactNumberInput" name="contactNumberInput" value="<?php echo $contactNumber; ?>" placeholder="Enter the Contact number" oninput="validateContactNumber()" required>
                <span id="contacterror"></span>
            </div><br>
        
            <div class="form-group">
                <label for="whatsappInput">Whatsapp</label>
                <input type="text" class="form-control" id="whatsappInput" name="whatsappInput" value="<?php echo $whatsapp; ?>" placeholder="Enter the Whatsapp number" oninput="validateWhatsapp()">
                <span id="whatsapperror"></span>
            </div><br>
        
            <div class="form-group">
            <label for="facebookInput">Facebook</label>
            <input type="text" class="form-control" id="facebookInput" name="facebookInput" value="<?php echo $facebook; ?>" placeholder="Enter the URL" oninput="validateUrl('facebook', this.value)">
            <span id="facebookError"></span>
        </div>
            <br>
            <div class="form-group">
                <label for="linkedinInput">Linkedin</label>
                <input type="text" class="form-control" id="linkedinInput" name="linkedinInput" value="<?php echo $linkedin; ?>" placeholder="Enter the URL" oninput="validateUrl('linkedin', this.value)">
                <span id="linkedinError"></span>
            </div>
            <br>
            <div class="form-group">
                <label for="instagramInput">Instagram</label>
                <input type="text" class="form-control" id="instagramInput" name="instagramInput" value="<?php echo $instagram; ?>" placeholder="Enter the URL" oninput="validateUrl('instagram', this.value)">
                <span id="instagramError"></span>
            </div>
            <br>
            <div class="form-group">
                <label for="emailInput">Email</label>
                <input type="text" class="form-control" id="emailInput" name="emailInput" value="<?php echo $email; ?>" placeholder="Enter the email address" oninput="validateEmail()" required>
                <span id="emailerror"></span>
            </div><br>
        
            <div id="btn">
                <button type="submit" class="btn btn-success" id="btn1">Update</button>
            </div>
        </form>
    </div>
